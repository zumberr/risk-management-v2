...
import { getGeologicalData } from '@/lib/geoData';
...
const Index = () => {
  ...
  const handleAnalysis = async () => {
    ...
    try {
      const geoData = getGeologicalData(lat, lng, selectedVereda);
      const riskAnalysis = calculateLandslideRisk(geoData);
      
      // Calcular riesgo general
      const overallRisk = Math.round((riskAnalysis.landslideRisk + riskAnalysis.collapseRisk) / 2);
      ...
      const newRiskData: RiskData = {
        ...
        landslideRisk: riskAnalysis.landslideRisk,
        collapseRisk: riskAnalysis.collapseRisk,
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="border-0 shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-center">Riesgo de Deslizamiento</CardTitle>
                    </CardHeader>
                  ...
                  <Card className="border-0 shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-center">Riesgo de Colapso</CardTitle>
                    </CardHeader>
                    <CardContent className="text-center">
                  ...
                  <Card className="border-0 shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-center">Riesgo General</CardTitle>
                    </CardHeader>
                    <CardContent className="text-center">
